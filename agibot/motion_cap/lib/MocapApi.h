...
#define MOCAP_API_VERSION_BUILD 19
#define MOCAP_API_VERSION_REVISION 9c65ff2a
...
class IMCPRigidBody {
 public:
  virtual EMCPError GetRigidBodyRotation(
      float* x, float* y, float* z, float* w,
      MCPRigidBodyHandle_t ulRigidBodyHandle) = 0;
  virtual EMCPError GetRigidBodyPosition(
      float* x, float* y, float* z, MCPRigidBodyHandle_t ulRigidBodyHandle) = 0;
  virtual EMCPError GetRigidBodyStatus(
      int* status, MCPRigidBodyHandle_t ulRigidBodyHandle) = 0;
  virtual EMCPError GetRigidBodyId(int* id,
                                   MCPRigidBodyHandle_t ulRigidBodyHandle) = 0;
  virtual EMCPError GetRigidBodyJointTag(
      EMCPJointTag* jointTag_, MCPRigidBodyHandle_t ulRigidBodyHandle) = 0;
  virtual EMCPError GetRigidBodyAxisAngle(
...
class IMCPTracker {
 public:
  ...
  virtual EMCPError GetTrackerRotation(float* x, float* y, float* z, float* w,
                                       const char* deviceName,
                                       MCPTrackerHandle_t ulTrackerHandle) = 0;
  virtual EMCPError GetTrackerPosition(float* x, float* y, float* z,
                                       const char* deviceName,
                                       MCPTrackerHandle_t ulTrackerHandle) = 0;
  virtual EMCPError GetTrackerEulerAng(float* x, float* y, float* z,
                                       const char* deviceName,
                                       MCPTrackerHandle_t ulTrackerHandle) = 0;
...
class IMCPSensorModule {
 public:
  virtual EMCPError GetSensorModulePosture(
      float* x, float* y, float* z, float* w,
      MCPSensorModuleHandle_t sensorModuleHandle) = 0;
  virtual EMCPError GetSensorModuleAngularVelocity(
      float* x, float* y, float* z,
      MCPSensorModuleHandle_t sensorModuleHandle) = 0;
  virtual EMCPError GetSensorModuleAcceleratedVelocity(
      float* x, float* y, float* z,
      MCPSensorModuleHandle_t sensorModuleHandle) = 0;
  virtual EMCPError GetSensorModuleId(
      uint32_t* id, MCPSensorModuleHandle_t sensorModuleHandle) = 0;
  virtual EMCPError GetSensorModuleCompassValue(
      float* x, float* y, float* z,
      MCPSensorModuleHandle_t sensorModuleHandle) = 0;
  virtual EMCPError GetSensorModuleTemperature(
      float* temperature, MCPSensorModuleHandle_t sensorModuleHandle) = 0;
  virtual EMCPError GetSensorModulePostureTimeCode(
      uint32_t* hour, uint32_t* minute, uint32_t* second, uint32_t* frame,
      uint32_t* rate, MCPSensorModuleHandle_t sensorModuleHandle) = 0;
  virtual EMCPError GetSensorModulePostureTime(
...
class IMCPBodyPart {
 public:
  ...
  virtual EMCPError GetJointDisplacementSpeed(
      float* x, float* y, float* z, MCPBodyPartHandle_t bodyPartHandle) = 0;
...
class IMCPJoint {
 public:
  ...
  virtual EMCPError GetJointLocalRotation(float* x, float* y, float* z,
                                          float* w,
                                          MCPJointHandle_t ulJointHandle) = 0;
  virtual EMCPError GetJointLocalRotationByEuler(
      float* x, float* y, float* z, MCPJointHandle_t ulJointHandle) = 0;
  virtual EMCPError GetJointLocalPosition(float* x, float* y, float* z,
                                          MCPJointHandle_t ulJointHandle) = 0;
  virtual EMCPError GetJointDefaultLocalPosition(
      float* x, float* y, float* z, MCPJointHandle_t ulJointHandle) = 0;
  ...
  virtual EMCPError GetJointBodyPart(MCPBodyPartHandle_t* pBodyPartHandle,
                                     MCPJointHandle_t ulJointHandle) = 0;
  virtual EMCPError GetJointSensorModule(
      MCPSensorModuleHandle_t* pSensorModuleHandle,
      MCPJointHandle_t ulJointHandle) = 0;
  ...
  virtual EMCPError GetJointGroundingState(EMCPGroundingState* pGroundingState,
                                           MCPJointHandle_t ulJointHandle) = 0;
  virtual EMCPError GetJointGroundablePoints(
      float* pointsPostion, uint32_t* numberOfPoints, uint32_t* plowest_index,
      MCPJointHandle_t ulJointHandle) = 0;
  virtual EMCPError GetJointGlobalRotation(float* x, float* y, float* z,
                                           float* w,
                                           MCPJointHandle_t ulJointHandle) = 0;
  virtual EMCPError GetJointGlobalPosition(float* x, float* y, float* z,
                                           MCPJointHandle_t ulJointHandle) = 0;
};
...
class IMCPAvatar {
 public:
  ...
  virtual EMCPError GetAvatarRootJoint(MCPJointHandle_t* pJointHandle,
                                       MCPAvatarHandle_t ulAvatarHandle) = 0;
  virtual EMCPError GetAvatarJoints(MCPJointHandle_t* pJointHandle,
                                    uint32_t* punSizeOfJointHandle,
                                    MCPAvatarHandle_t ulAvatarHandle) = 0;
  virtual EMCPError GetAvatarJointByName(const char* name,
                                         MCPJointHandle_t* pJointHandle,
                                         MCPAvatarHandle_t ulAvatarHandle) = 0;
  virtual EMCPError GetAvatarName(const char** ppStr,
                                  MCPAvatarHandle_t ulAvatarHandle) = 0;
  virtual EMCPError GetAvatarRigidBodies(MCPRigidBodyHandle_t* vRigidBodies,
                                         uint32_t* punSizeOfRigidBodies,
                                         MCPAvatarHandle_t ulAvatarHandle) = 0;
  virtual EMCPError GetAvatarJointHierarchy(const char** ppStr) = 0;
  virtual EMCPError GetAvatarPostureIndex(uint32_t* postureIndex,
                                          MCPAvatarHandle_t ulAvatarHandle) = 0;
  virtual EMCPError GetAvatarPostureTimeCode(
      uint32_t* hour, uint32_t* minute, uint32_t* second, uint32_t* frame,
      uint32_t* rate, MCPAvatarHandle_t ulAvatarHandle) = 0;
  virtual EMCPError GetAvatarPostureTime(uint32_t* hour, uint32_t* minute,
                                         uint32_t* second,
...
class IMCPMarker {
 public:
  virtual EMCPError GetMarkerPosition(float* x, float* y, float* z,
                                      MCPMarkerHandle_t handle) = 0;
};
...
class IMCPPWR {
 public:
  ...
  virtual EMCPError GetPWRPosition(float* x, float* y, float* z,
                                   MCPPWRHandle_t handle) = 0;
  virtual EMCPError GetPWRQuaternion(float* x, float* y, float* z, float* w,
                                     MCPPWRHandle_t handle) = 0;
};
...
class IMCPAliceHub {
 public:
  virtual EMCPError GetSensorModuleList(MCPSensorModuleHandle_t* pHandles,
                                        uint32_t* nHandles) = 0;
  virtual EMCPError GetSensorModuleTimestamp(uint64_t* timestamp) = 0;
  virtual EMCPError GetMarkerList(MCPMarkerHandle_t* pHandles,
                                  uint32_t* nHandles) = 0;
  virtual EMCPError GetMarkerTimestamp(uint64_t* timestamp) = 0;
  virtual EMCPError GetRigidBodyList(MCPRigidBodyHandle_t* pHandles,
                                     uint32_t* nHandles) = 0;
  virtual EMCPError GetRigidBodyTimestamp(uint64_t* timestamp) = 0;
  virtual EMCPError GetPWRList(MCPPWRHandle_t* pHandles,
                               uint32_t* nHandles) = 0;
...
enum EMCPCommandProgress { CommandProgress_CalibrateMotion = 0 };
typedef uint64_t MCPCommandHandle_t;
class IMCPCommand {
 public:
  virtual EMCPError CreateCommand(uint32_t cmd,
                                  MCPCommandHandle_t* handle_) = 0;
  virtual EMCPError SetCommandExtraFlags(uint32_t extraFlags,
                                         MCPCommandHandle_t handle_) = 0;
  virtual EMCPError SetCommandExtraLong(uint32_t extraLongIndex,
                                        intptr_t extraLong,
                                        MCPCommandHandle_t handle_) = 0;
  virtual EMCPError GetCommandResultMessage(const char** pMsg,
                                            MCPCommandHandle_t handle_) = 0;
  virtual EMCPError GetCommandResultCode(uint32_t* pResCode,
                                         MCPCommandHandle_t handle_) = 0;
  virtual EMCPError GetCommandProgress(uint32_t progress, intptr_t extra,
                                       MCPCommandHandle_t handle_) = 0;
  ...
  virtual EMCPError DuplicateCommand(MCPCommandHandle_t* duplicateCmd,
                                     MCPCommandHandle_t handle_) = 0;
  virtual EMCPError AddCommandExtraLong(uint32_t extraLongIndex,
                                        intptr_t extraLong,
                                        MCPCommandHandle_t handle_) = 0;
  virtual EMCPError GetCommandExtraLong(uint32_t extraLongIndex,
                                        intptr_t* pExtraLong,
                                        MCPCommandHandle_t handle_) = 0;
  virtual EMCPError RemoveCommandExtraLong(uint32_t extraLongIndex,
                                           MCPCommandHandle_t handle_) = 0;
  virtual EMCPError GetCommandTag(uint32_t* pTag,
                                  MCPCommandHandle_t handle_) = 0;
};
...
class IMCPCalibrateMotionProgress {
 public:
  virtual EMCPError GetCalibrateMotionProgressCountOfSupportPoses(
      uint32_t* pCount, MCPCalibrateMotionProgressHandle_t handle_) = 0;
  virtual EMCPError GetCalibrateMotionProgressNameOfSupportPose(
      char* name, uint32_t* pLenOfName, uint32_t index,
      MCPCalibrateMotionProgressHandle_t handle_) = 0;
  virtual EMCPError GetCalibrateMotionProgressStepOfPose(
      uint32_t* pStep, const char* name,
      MCPCalibrateMotionProgressHandle_t handle_) = 0;
  virtual EMCPError GetCalibrateMotionProgressCountdownOfPose(
      uint32_t* pCountdown, const char* name,
      MCPCalibrateMotionProgressHandle_t handle_) = 0;
  virtual EMCPError GetCalibrateMotionProgressProgressOfPose(
      uint32_t* pProgress, const char* name,
      MCPCalibrateMotionProgressHandle_t handle_) = 0;
  virtual EMCPError GetCalibrateMotionProgressStepOfCurrentPose(
      uint32_t* pStep, char* name, uint32_t* pLenOfName,
      MCPCalibrateMotionProgressHandle_t handle_) = 0;
  virtual EMCPError GetCalibrateMotionProgressCountdownOfCurrentPose(
      uint32_t* pCountdown, char* name, uint32_t* pLenOfName,
      MCPCalibrateMotionProgressHandle_t handle_) = 0;
  virtual EMCPError GetCalibrateMotionProgressProgressOfCurrentPose(
      uint32_t* pProgress, char* name, uint32_t* pLenOfName,
      MCPCalibrateMotionProgressHandle_t handle_) = 0;
};
static const char* IMCPCalibrateMotionProgress_Version =
    "IMCPCalibrateMotionProgress_001";
typedef uint64_t MCPSystemHandle_t;
class IMCPSystem {
 public:
  virtual EMCPError GetMasterVersion(const char** pstr,
                                     MCPSystemHandle_t handle) = 0;
  virtual EMCPError GetMasterSerialNumber(const char** pstr,
                                          MCPSystemHandle_t handle) = 0;
};
...
class IMCPSettings {
 public:
  ...
  virtual EMCPError SetSettingsTCP(const char* serverIp, uint16_t serverPort,
                                   MCPSettingsHandle_t ulSettingsHandle) = 0;
  virtual EMCPError SetSettingsBvhRotation(
      EMCPBvhRotation bvhRotation, MCPSettingsHandle_t ulSettingsHandle) = 0;
  virtual EMCPError SetSettingsBvhTransformation(
      EMCPBvhTransformation bvhTransformation,
      MCPSettingsHandle_t ulSettingsHandle) = 0;
  virtual EMCPError SetSettingsBvhData(
      EMCPBvhData bvhData, MCPSettingsHandle_t ulSettingsHandle) = 0;
  virtual EMCPError SetSettingsCalcData(
      MCPSettingsHandle_t ulSettingsHandle) = 0;
  virtual EMCPError SetSettingsUDPServer(
      const char* serverIp, uint16_t serverPort,
      MCPSettingsHandle_t ulSettingsHandle) = 0;
  virtual EMCPError SetSettingsUDPEx(const char* localIp, uint16_t localPort,
                                     MCPSettingsHandle_t ulSettingsHandle) = 0;
};
...
enum EMCPFrontVector { FrontVector_ParityEven = 1, FrontVector_ParityOdd = 2 };
...
enum EMCPUnit { Unit_Centimeter = 0, Uint_Meter = 1 };
typedef uint64_t MCPRenderSettingsHandle_t;
class IMCPRenderSettings {
 public:
  virtual EMCPError CreateRenderSettings(
      MCPRenderSettingsHandle_t* pRenderSettings) = 0;
  virtual EMCPError GetPreDefRenderSettings(
      EMCPPreDefinedRenderSettings preDefinedRenderSettings,
      MCPRenderSettingsHandle_t* pRenderSettings) = 0;
  ...
  virtual EMCPError GetUpVector(EMCPUpVector* pUpVector, int* sign,
                                MCPRenderSettingsHandle_t renderSettings) = 0;
  virtual EMCPError SetFrontVector(
      EMCPFrontVector frontVector, int sign,
      MCPRenderSettingsHandle_t renderSettings) = 0;
  virtual EMCPError GetFrontVector(
      EMCPFrontVector* pFrontVector, int* sign,
      MCPRenderSettingsHandle_t renderSettings) = 0;
  virtual EMCPError SetCoordSystem(
      EMCPCoordSystem coordSystem,
      MCPRenderSettingsHandle_t renderSettings) = 0;
  virtual EMCPError GetCoordSystem(
      EMCPCoordSystem* pCoordSystem,
      MCPRenderSettingsHandle_t renderSettings) = 0;
  virtual EMCPError SetRotatingDirection(
      EMCPRotatingDirection rotatingDirection,
      MCPRenderSettingsHandle_t renderSettings) = 0;
  virtual EMCPError GetRotatingDirection(
      EMCPRotatingDirection* pRotatingDirection,
      MCPRenderSettingsHandle_t renderSettings) = 0;
  virtual EMCPError SetUnit(EMCPUnit mcpUnit,
                            MCPRenderSettingsHandle_t renderSettings) = 0;
  virtual EMCPError GetUnit(EMCPUnit* mcpUnit,
                            MCPRenderSettingsHandle_t renderSettings) = 0;
  virtual EMCPError DestroyRenderSettings(
      MCPRenderSettingsHandle_t renderSettings) = 0;
};
...
class IMCPApplication {
 public:
  virtual EMCPError CreateApplication(
      MCPApplicationHandle_t* ulApplicationHandle) = 0;
  virtual EMCPError DestroyApplication(
      MCPApplicationHandle_t ulApplicationHandle) = 0;
  virtual EMCPError SetApplicationSettings(
      MCPSettingsHandle_t ulSettingsHandle,
      MCPApplicationHandle_t ulApplicationHandle) = 0;
  virtual EMCPError SetApplicationRenderSettings(
      MCPRenderSettingsHandle_t ulRenderSettings,
      MCPApplicationHandle_t ulApplicationHandle) = 0;
  virtual EMCPError OpenApplication(
      MCPApplicationHandle_t ulApplicationHandle) = 0;
  virtual EMCPError EnableApplicationCacheEvents(
      MCPApplicationHandle_t ulApplicationHandle) = 0;
  virtual EMCPError DisableApplicationCacheEvents(
      MCPApplicationHandle_t ulApplicationHandle) = 0;
  virtual EMCPError ApplicationCacheEventsIsEnabled(
      bool* isEnabled, MCPApplicationHandle_t ulApplicationHandle) = 0;
  virtual EMCPError CloseApplication(
      MCPApplicationHandle_t ulApplicationHandle) = 0;
  virtual EMCPError GetApplicationRigidBodies(
      MCPRigidBodyHandle_t* pRigidBodyHandle, uint32_t* punRigidBodyHandleSize,
      MCPApplicationHandle_t ulApplicationHandle) = 0;
  virtual EMCPError GetApplicationAvatars(
      MCPAvatarHandle_t* pAvatarHandle, uint32_t* punAvatarHandle,
      MCPApplicationHandle_t ulApplicationHandle) = 0;
  virtual EMCPError PollApplicationNextEvent(
      MCPEvent_t* pEvent, uint32_t* punSizeOfEvent,
      MCPApplicationHandle_t ulApplicationHandle) = 0;
  virtual EMCPError GetApplicationSensorModules(
      MCPSensorModuleHandle_t* pSensorModuleHandle,
      uint32_t* punSensorModuleHandle,
      MCPApplicationHandle_t ulApplicationHandle) = 0;
  virtual EMCPError GetApplicationTrackers(
      MCPTrackerHandle_t* pTrackerHandle, uint32_t* punTrackerHandle,
      MCPApplicationHandle_t ulApplicationHandle) = 0;
  virtual EMCPError QueuedServerCommand(
      MCPCommandHandle_t cmdHandle,
      MCPApplicationHandle_t ulApplicationHandle) = 0;
  virtual EMCPError RegisterEventHandler(
      MCPEventHandleProc eventHandleProc, intptr_t userData,
      MCPApplicationHandle_t ulApplicationHandle) = 0;
  virtual EMCPError UnregisterEventHandler(
      MCPEventHandleProc eventHandleProc, intptr_t* userData,
      MCPApplicationHandle_t ulApplicationHandle) = 0;
  virtual EMCPError GetAppplicationSystem(
      MCPSystemHandle_t* pSystemHandle,
      MCPApplicationHandle_t ulApplicationHandle) = 0;
};
...
class IMCPRecordNotify {
 public:
  virtual EMCPError DuplicateRecordNotify(
      MCPRecordNotifyHandle_t* duplicatedRecordNotifyHandle,
      MCPRecordNotifyHandle_t recordNotifyHandle) = 0;
  virtual EMCPError RecordNotifyGetTakeName(
      const char** takeName, MCPRecordNotifyHandle_t recordNotifyHandle) = 0;
  virtual EMCPError RecordNotifyGetTakePath(
      const char** takePath, MCPRecordNotifyHandle_t recordNotifyHandle) = 0;
  virtual EMCPError RecordNotifyGetTakeSaveDir(
      const char** takeSaveDir, MCPRecordNotifyHandle_t recordNotifyHandle) = 0;
  virtual EMCPError RecordNotifyGetTakeFileSuffix(
      const char** takeFileSuffix,
      MCPRecordNotifyHandle_t recordNotifyHandle) = 0;
  virtual EMCPError DestroyRecordNotify(
      MCPRecordNotifyHandle_t recordNotifyHandle) = 0;
};
...
class IMCPRobot {
 public:
  virtual EMCPError CreateRobot(const char* jsonConfigStr,
                                MCPRobotHandle_t* pHandle) = 0;
  virtual EMCPError SetRobotFPS(int fps, MCPRobotHandle_t handle) = 0;
  virtual EMCPError UpdateRobot(MCPAvatarHandle_t avatarHandle,
                                MCPRobotHandle_t handle) = 0;
  virtual EMCPError GetRobotRawJointAngle(EMCPRobotJointType jointType,
                                          float* value,
                                          MCPRobotHandle_t handle) = 0;
  virtual EMCPError GetRobotRetargetJointAngle(const char* jointName,
                                               float* value,
                                               MCPRobotHandle_t handle) = 0;
  virtual EMCPError GetRobotRosFrameJson(const char** jsonStr, bool compress,
                                         MCPRobotHandle_t handle) = 0;
  virtual EMCPError GetRobotRootRotation(float* x, float* y, float* z, float* w,
                                         MCPRobotHandle_t handle) = 0;
  virtual EMCPError GetRobotRootPosition(float* x, float* y, float* z,
                                         MCPRobotHandle_t handle) = 0;
  virtual EMCPError DestroyRobot(MCPRobotHandle_t handle) = 0;
};
static const char* IMCPRobot_Version = "IMCPRobot_001";
MCP_INTERFACE EMCPError MCP_CALLTYPE
MCPGetGenericInterface(const char* pchInterfaceVersion, void** ppInterface);
MCP_INTERFACE void MCP_CALLTYPE MCPGetMocapApiVersion(uint32_t* major,
                                                      uint32_t* minor,
                                                      uint32_t* build,
                                                      uint32_t* revision);
