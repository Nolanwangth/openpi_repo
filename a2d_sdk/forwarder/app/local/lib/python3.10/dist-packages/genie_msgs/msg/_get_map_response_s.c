...
#include "genie_msgs/msg/detail/get_map_response__struct.h"
#include "genie_msgs/msg/detail/get_map_response__functions.h"
...
bool genie_msgs__msg__get_map_response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("genie_msgs.msg._get_map_response.GetMapResponse", full_classname_dest, 47) == 0);
  }
  genie_msgs__msg__GetMapResponse * ros_message = _ros_message;
  {  // header
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * genie_msgs__msg__get_map_response__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of GetMapResponse */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("genie_msgs.msg._get_map_response");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetMapResponse");
  ...
  genie_msgs__msg__GetMapResponse * ros_message = (genie_msgs__msg__GetMapResponse *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
