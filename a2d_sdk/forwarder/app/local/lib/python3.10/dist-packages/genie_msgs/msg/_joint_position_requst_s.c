...
// with input from genie_msgs:msg/JointPositionRequst.idl
...
#include "genie_msgs/msg/detail/joint_position_requst__struct.h"
#include "genie_msgs/msg/detail/joint_position_requst__functions.h"
...
bool genie_msgs__msg__joint_position_requst__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("genie_msgs.msg._joint_position_requst.JointPositionRequst", full_classname_dest, 57) == 0);
  }
  genie_msgs__msg__JointPositionRequst * ros_message = _ros_message;
  {  // header
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * genie_msgs__msg__joint_position_requst__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of JointPositionRequst */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("genie_msgs.msg._joint_position_requst");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointPositionRequst");
  ...
  genie_msgs__msg__JointPositionRequst * ros_message = (genie_msgs__msg__JointPositionRequst *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
