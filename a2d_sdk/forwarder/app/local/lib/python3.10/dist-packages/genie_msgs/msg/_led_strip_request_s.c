...
// with input from genie_msgs:msg/LedStripRequest.idl
...
#include "genie_msgs/msg/detail/led_strip_request__struct.h"
#include "genie_msgs/msg/detail/led_strip_request__functions.h"
...
bool genie_msgs__msg__led_strip_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("genie_msgs.msg._led_strip_request.LedStripRequest", full_classname_dest, 49) == 0);
  }
  genie_msgs__msg__LedStripRequest * ros_message = _ros_message;
  {  // header
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * genie_msgs__msg__led_strip_request__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of LedStripRequest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("genie_msgs.msg._led_strip_request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LedStripRequest");
  ...
  genie_msgs__msg__LedStripRequest * ros_message = (genie_msgs__msg__LedStripRequest *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
