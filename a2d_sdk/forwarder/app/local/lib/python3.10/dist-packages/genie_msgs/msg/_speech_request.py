...
class Metaclass_SpeechRequest(type):
    """Metaclass of message 'SpeechRequest'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'genie_msgs.msg.SpeechRequest')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__speech_request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__speech_request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__speech_request
            cls._TYPE_SUPPORT = module.type_support_msg__msg__speech_request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__speech_request
...
class SpeechRequest(metaclass=Metaclass_SpeechRequest):
    """Message class 'SpeechRequest'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.urgent = kwargs.get('urgent', bool())
    ...
    def urgent(self, value):
        if __debug__:
            assert \
                ...
                "The 'urgent' field must be of type 'bool'"
        self._urgent = value
